...
public class ProfileFragment extends Fragment {
    ...
    private static final String DIALOG_LANG = "language";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       ;
        ...
        mLangButton = (Button)rootView.findViewById(R.id.lang_button);
        ...
        LangButtonOnClickListener langButtonOnClickListener = new LangButtonOnClickListener();
        updateDoB();
        mDoBButton.setOnClickListener(doBButtonOnClickListener);
        mLangButton.setOnClickListener(langButtonOnClickListener);
    ...
    private class LangButtonOnClickListener implements View.OnClickListener {
        public void onClick(View v) {
            FragmentManager fm = getActivity()
                    .getSupportFragmentManager();

            LanguageFragment dialog = LanguageFragment
                    .newInstance(mProfile.getLang());

            dialog.setTargetFragment(ProfileFragment.this, REQUEST_LANG);
